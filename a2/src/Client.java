...
public class Client extends Thread {
  ...
  public void readTransactions() {
    ...
    try {
      inputStream = new Scanner(new FileInputStream("src/input/transaction2.txt"));
    } catch (FileNotFoundException e) {
      System.out.println("File transaction2.txt was not found or could not be opened.");
      System.exit(0);
    }
  ...
  public void run() {
    ...
    if (getClientOperation().equals("sending")) {
      ...
      Transactions dummy = new Transactions();
    ...
    System.out.println("\n Terminating client " + getClientOperation() + " thread - Running time " + (System.currentTimeMillis() - start) + "ms");
  }
}
